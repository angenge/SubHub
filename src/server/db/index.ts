...
try {
  sqlite.exec(`ALTER TABLE subscriptions ADD COLUMN etag TEXT;`);
} catch {}
try {
  sqlite.exec(`ALTER TABLE subscriptions ADD COLUMN last_modified TEXT;`);
} catch {}
try {
  sqlite.exec(`ALTER TABLE aggregates ADD COLUMN access_count INTEGER DEFAULT 0;`);
} catch {}
try {
  sqlite.exec(`ALTER TABLE aggregates ADD COLUMN last_accessed_at TEXT;`);
} catch {}
try {
  sqlite.exec(`ALTER TABLE aggregates ADD COLUMN last_accessed_ip TEXT;`);
} catch {}
